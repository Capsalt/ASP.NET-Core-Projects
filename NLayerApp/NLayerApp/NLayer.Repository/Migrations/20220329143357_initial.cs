    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2022, 3, 29, 17, 33, 56, 881, DateTimeKind.Local).AddTicks(139), "Kalem1", 100m, 20, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreateDate", "Name", "Price", "Stock", "UpdateDate" },
                values: new object[] { 2, 1, new DateTime(2022, 3, 29, 17, 33, 56, 881, DateTimeKind.Local).AddTicks(7408), "Kalem2", 300m, 60, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreateDate", "Name", "Price", "Stock", "UpdateDate" },
                values: new object[] { 3, 2, new DateTime(2022, 3, 29, 17, 33, 56, 881, DateTimeKind.Local).AddTicks(7419), "Kitap1", 200m, 30, null });
